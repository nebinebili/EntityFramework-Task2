    ...
    public partial class inital : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders", x => new { x.CustomerId, x.EmployeeId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderEmployeeId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetails", x => new { x.OrderId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_OrderDetails_Orders_OrderCustomerId_OrderEmployeeId",
                        columns: x => new { x.OrderCustomerId, x.OrderEmployeeId },
                        principalTable: "Orders",
                        principalColumns: new[] { "CustomerId", "EmployeeId" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_OrderCustomerId_OrderEmployeeId",
                table: "OrderDetails",
                columns: new[] { "OrderCustomerId", "OrderEmployeeId" });
